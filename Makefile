...
.PHONY: install install-dev lint typecheck test security check ci
...
test:
	$(PYTHON) -m unittest tests/test_execution_core.py tests/test_nexus_config.py tests/test_nexus_pipeline.py
