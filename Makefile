...
.PHONY: install install-dev lint typecheck test security contract-test cockpit-contract-smoke cockpit-bridge-smoke check ci
...
cockpit-contract-smoke:
	$(PYTHON) scripts/run_nexus_cockpit_contract_smoke.py


cockpit-bridge-smoke:
	$(PYTHON) scripts/run_nexus_cockpit_bridge_smoke.py
