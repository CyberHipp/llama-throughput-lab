...
test:
	$(PYTHON) -m unittest tests/test_execution_core.py tests/test_nexus_config.py tests/test_nexus_pipeline.py tests/test_verify.py tests/test_nexus_tui.py tests/test_nexus_presets.py tests/test_nexus_queue.py tests/test_email_turn_adapter.py tests/test_run_core_job_cli.py tests/test_packet_schema.py
