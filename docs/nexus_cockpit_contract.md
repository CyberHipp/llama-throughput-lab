...
- `schemas/nexus_cockpit_action_specs_v1.json`
...
python scripts/validate_nexus_cockpit_contract.py --kind action_specs --json-file tests/fixtures/cockpit/action_specs_example.json
